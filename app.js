...
const plantsData = [
  ...
  { id: 14, name: "4 Season Longan", image: "image copy 210.png", origin: "Brazil", type: "Exotic", tag: "exotic", desc: "A vibrant yellow tropical fruit with a tangy-sweet flavor profile, perfect for exotic fruit gardens." },
  ...
  { id: 165, name: "Yellow Sampangi Plant", image: "image copy 169.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "A beautiful variety of Sampangi with vibrant yellow flowers, known for its sweet, rich fragrance and ornamental value." },
  { id: 166, name: "White Sampangi Plant", image: "image copy 170.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Elegant plant with pristine white blossoms that release a highly soothing and sweet aroma, ideal for home gardens." },
  { id: 167, name: "Thaii Green Sampangi", image: "image copy 171.png", origin: "Thailand", type: "Fruit Variety", tag: "imported", desc: "A premium Thai variety of the Sampangi plant featuring greenish flowers with a unique, exotic tropical scent." },
  { id: 168, name: "Kani Giri Samoangi Plant", image: "image copy 172.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "A localized selection of the fragrant Sampangi plant, popular for its strong perfume and lush green foliage." },
  { id: 169, name: "Ratnagiri Sampangi", image: "image copy 173.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Prized Indian variety of Sampangi with beautiful, highly aromatic flowers that blossom continuously under good care." },
  { id: 170, name: "Panerr Pushpam", image: "image copy 174.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Traditional rose variety famous for its soft pink petals, sweet fragrance, and historical use in rose water preparation." },
  { id: 171, name: "Rudra Guava", image: "image copy 175.png", origin: "India", type: "Fruit Variety", tag: "bestseller", desc: "A hardy guava variety with excellent fruit yield, crispy texture, and sweet flavor. Adapts well to tropical conditions." },
  { id: 172, name: "Vietnam Super Early Jackfruit", image: "image copy 176.png", origin: "Vietnam", type: "Fruit Variety", tag: "imported", desc: "Fast-growing imported jackfruit variety that bears sweet, firm pods much earlier than traditional varieties." },
  { id: 173, name: "Konda Mavidi", image: "image copy 177.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "A wild or forest mango variety prized for its unique, tangy-sweet flavor profile and traditional culinary uses." },
  { id: 174, name: "Red Lemon", image: "image copy 178.png", origin: "China", type: "Fruit Variety", tag: "exotic", desc: "Fascinating citrus variety producing juicy lemons with reddish skin and a highly refreshing, sour-sweet taste." },
  { id: 175, name: "Malayan Apple", image: "image copy 179.png", origin: "Malaysia", type: "Fruit Variety", tag: "imported", desc: "Also known as Malay Rose Apple. Features beautiful red bell-shaped fruits with a crisp, sweet, and juicy bite." },
  { id: 176, name: "Karpuram Plant", image: "image copy 180.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "A highly aromatic variety of camphor/tulsi or banana relative known locally for its strong, camphor-like scent." },
  { id: 177, name: "Madhi Phalam", image: "image copy 181.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Also known as Citron. Large fruit with thick rind, highly valued in traditional medicine and for making premium pickles." },
  { id: 178, name: "Elachi Plant", image: "image copy 182.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "A cardamom plant producing aromatic leaves and seeds, perfect for spice gardens and home cultivation." },
  { id: 179, name: "Savannah Cherry", image: "image copy 183.png", origin: "South America", type: "Fruit Variety", tag: "exotic", desc: "A rare tropical cherry variety that produces abundant, bright red, sweet-sour fruits rich in vitamins." },
  { id: 180, name: "Mottom Jack", image: "image copy 184.png", origin: "Malaysia", type: "Fruit Variety", tag: "imported", desc: "Premium imported jackfruit variety known for its dense, crispy, and exceptionally sweet yellow-orange pods." },
  { id: 181, name: "Killi Naval", image: "image copy 185.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "A select variety of Jamun (Black Plum) producing large, sweet, dark purple fruits with high medicinal properties." },
  { id: 182, name: "Balnagar Seethaphal", image: "image copy 186.png", origin: "India", type: "Fruit Variety", tag: "bestseller", desc: "Popular Indian custard apple variety known for its large size, high pulp content, and sweet, creamy texture." },
  { id: 183, name: "Velvet Apple", image: "image copy 187.png", origin: "Philippines", type: "Fruit Variety", tag: "exotic", desc: "Striking exotic tree bearing beautiful velvet-skinned fruits with a soft, creamy white pulp of mild sweetness." },
  { id: 184, name: "White Jamun", image: "image copy 188.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Rare jamun variety that bears translucent white fruits. Sweet and refreshing with a mild rose-like undertone." },
  { id: 185, name: "NMK Gold Custard Apple", image: "image copy 189.png", origin: "India", type: "Fruit Variety", tag: "bestseller", desc: "Highly premium selection of custard apple with golden-yellow skin and extra sweet, low-seed pulp." },
  { id: 186, name: "Cotton Neredu", image: "image copy 190.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "A unique Jamun relative with a soft, cottony pulp and refreshing sweet taste, growing well in local climates." },
  { id: 187, name: "Malabar Tamrind", image: "image copy 191.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Also known as Kudampuli. Popular in coastal cooking, it yields sour fruits used as a natural flavoring agent." },
  { id: 188, name: "Bush Pepper", image: "image copy 192.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "A compact black pepper plant variety that grows in a bush form, making it perfect for small gardens and pots." },
  { id: 189, name: "Coffee Plant", image: "image copy 193.png", origin: "Ethiopia", type: "Fruit Variety", tag: "exotic", desc: "Arabica coffee plant with glossy green leaves, producing fragrant white flowers and red coffee cherries." },
  { id: 190, name: "Lavangam Plant", image: "image copy 194.png", origin: "Indonesia", type: "Fruit Variety", tag: "imported", desc: "The true clove plant, growing into a beautiful evergreen tree with highly aromatic flower buds and leaves." },
  { id: 191, name: "Karakai Plant", image: "image copy 195.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Also known as Haritaki. Highly revered in Ayurveda, it produces medicinal fruits of high therapeutic value." },
  { id: 192, name: "Variegated Sapota", image: "image copy 196.png", origin: "Thailand", type: "Fruit Variety", tag: "imported", desc: "Stunning ornamental sapota featuring green and white marbled leaves and sweet, sandy-textured round fruits." },
  { id: 193, name: "Biryani Leaf", image: "image copy 197.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Bay leaf plant producing strongly aromatic leaves, a must-have spice in traditional rice dishes and curries." },
  { id: 194, name: "Basmati Plant", image: "image copy 198.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Aromatic plant whose leaves release a fragrance identical to Basmati rice, commonly used to scent desserts." },
  { id: 195, name: "China Orange", image: "image copy 199.png", origin: "China", type: "Fruit Variety", tag: "imported", desc: "Dwarf citrus tree bearing clusters of small, bright orange fruits that are sweet-sour and highly ornamental." },
  { id: 196, name: "Pomelo Inside Red", image: "image copy 200.png", origin: "Thailand", type: "Fruit Variety", tag: "imported", desc: "Large citrus fruit with thick skin and sweet, juicy red pulp inside. A premium Thai variety." },
  { id: 197, name: "Alla Neredu", image: "image copy 201.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Elite Jamun cultivar producing large, cylindrical berries of deep purple color, known for high juice content." },
  { id: 198, name: "Cricket Ball Sapota", image: "image copy 202.png", origin: "India", type: "Fruit Variety", tag: "bestseller", desc: "Popular sapota variety producing large, round fruits resembling cricket balls, filled with sweet granular pulp." },
  { id: 199, name: "Ahimla Apple", image: "image copy 203.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Low-chill apple variety adapted to warm climates, producing crisp fruits with a refreshing, sweet finish." },
  { id: 200, name: "Almond", image: "image copy 204.png", origin: "Middle East", type: "Fruit Variety", tag: "exotic", desc: "Hardy nut tree producing high-quality almonds, suitable for home orchards and dry, warm conditions." },
  { id: 201, name: "Ramphal Green", image: "image copy 205.png", origin: "India", type: "Fruit Variety", tag: "exotic", desc: "Green-skinned variety of Bullock's Heart, featuring sweet, custard-like creamy white pulp with minimal seeds." },
  { id: 202, name: "Thai Yellow Papaya", image: "image copy 206.png", origin: "Thailand", type: "Fruit Variety", tag: "imported", desc: "Premium Thai papaya variety known for its bright yellow skin and sweet, firm orange flesh with high yield." },
  { id: 203, name: "Rambutan School Boy", image: "image copy 207.png", origin: "Malaysia", type: "Fruit Variety", tag: "imported", desc: "Renowned Malaysian rambutan variety featuring hairy red fruits with exceptionally sweet and juicy white arils." },
  { id: 204, name: "Rambutan E35", image: "image copy 208.png", origin: "Malaysia", type: "Fruit Variety", tag: "imported", desc: "Highly productive rambutan cultivar producing thick-fleshed, sweet fruits that peel away easily from the seed." },
  { id: 205, name: "Anna Apple", image: "image copy 209.png", origin: "Israel", type: "Fruit Variety", tag: "imported", desc: "Famous low-chill golden-red apple variety developed in Israel, highly suited for cultivation in warm climates." },
];
...
function applyFilters() {
  ...
  if (currentFilter !== 'all') {
    result = result.filter(p => p.tag === currentFilter);
  }
  ...
  // 3. Apply sorting (A-Z if all plants is selected)
  if (currentFilter === 'all') {
    result.sort((a, b) => a.name.localeCompare(b.name));
  }

  renderPlantsGrid(result);
}
